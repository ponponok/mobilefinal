...
public class ProfileFragment extends Fragment {
    ...
    private void cre(){
        ...
        EditText _quote = getView().findViewById(R.id.profile_qoute);
        String _useridStr = share.getString("userid", "");
        String _nameStr = share.getString("name", "");
        String _ageStr = share.getString("age", "");
        String _passwordStr = share.getString("password", "");
        String _qouteStr = share.getString("quote", "");

        _userid.setText(_useridStr);
        _name.setText(_nameStr);
        _age.setText((_ageStr));
        _password.setText(_passwordStr);
        _quote.setText(_qouteStr);
    }
    ...
    private void save(){
        ...
        Button save = getView().findViewById(R.id.profile_save);
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(_useridStr.isEmpty() || _nameStr.isEmpty() || _ageStr.isEmpty() || _passwordStr.isEmpty()  ){
                    ...
                    cv.put("quote", _quoteStr);
                    myDB.update("user", cv, "userid='"+share.getString("userid", "")+"'", null);
                    myDB.close();

                    SharedPreferences.Editor ed = share.edit();
                    ed.putString("userid",_useridStr);
                    ed.putString("age", _ageStr);
                    ed.putString("name", _nameStr);
                    ed.putString("password", _passwordStr);
                    ed.putString("quote", _quoteStr);
                    ed.commit();
